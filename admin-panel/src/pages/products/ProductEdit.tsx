...
const ProductEdit = () => {
  ...
  const fetchProduct = async () => {
    try {
      ...
      setFormData({
        ...
        description: productData.description,
        category: typeof productData.category === 'object' ? productData.category._id : productData.category,
        subcategory: typeof productData.subcategory === 'object' ? productData.subcategory?._id : productData.subcategory,
        brand: typeof productData.brand === 'object' ? productData.brand?._id : productData.brand,
        basePrice: productData.basePrice,
        compareAtPrice: productData.compareAtPrice || 0,
        images: productData.images || [],
  ...
  const handleDeleteVariant = async () => {
    ...
    try {
      await api.delete(`/products/${id}/variants/${variantToDelete}`);
      setVariants(variants.filter((v) => v._id !== variantToDelete));
  ...
  const handleAddVariant = () => {
    const newVariant: ProductVariant = {
      sku: `${formData.name.en.substring(0, 3).toUpperCase()}-NEW-${variants.length + 1}`,
      size: '',
      color: '',
      material: '',
  ...
  return (
    <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <label className="flex flex-col items-center justify-center h-32 border-2 border-dashed rounded-lg cursor-pointer hover:bg-accent">
                  ...
                  >
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      ...
                      <div>
                        ...
                        <Input
                          value={variant.size || ''}
                          onChange={(e) =>
                            handleUpdateVariant(variantIndex, 'size', e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          value={variant.color || ''}
                          onChange={(e) =>
                            handleUpdateVariant(variantIndex, 'color', e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          value={variant.material || ''}
                          onChange={(e) =>
                            handleUpdateVariant(variantIndex, 'material', e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          //   )
                          // }
                          // placeholder={`Default: ${formData.basePrice}`}
                        />
                      </div>
                      <div>
                    ...
                    <div className="flex items-center gap-2">
                      <Switch
                        checked={variant.isActive}
                        onCheckedChange={(checked) =>
                          handleUpdateVariant(variantIndex, 'isActive', checked)
                        }
                      />
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mt-2 flex-wrap">
                        {variant.images.map((img, imgIndex) => (
                          <div key={imgIndex} className="relative group">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                handleRemoveVariantImage(variantIndex, imgIndex)
                              }
                            >
                              <X className="h-3 w-3" />
                            </Button>
                        ...
                        <label className="h-16 w-16 border-2 border-dashed rounded flex items-center justify-center cursor-pointer hover:bg-accent">
                          <Upload className="h-4 w-4 text-muted-foreground" />
                          <input
                            type="file"
                            accept="image/*"
      ...
      <AlertDialog open={deleteVariantDialog} onOpenChange={setDeleteVariantDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete Variant?</AlertDialogTitle>
            <AlertDialogDescription>
