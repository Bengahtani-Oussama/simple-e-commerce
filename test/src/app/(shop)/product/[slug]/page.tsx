...
export default function ProductDetailPage() {
  ...
  const handleAddToCart = async () => {
    ...
    if (!selectedVariant) {
      toast({
        title: ('common.error'),
        // title: t('common.error'),
        description: ('products.selectVariant'),
    ...
    try {
      ...
      toast({
        title: ('cart.title'),
        // title: t('cart.title'),
        description: ('products.addToCart'),
  ...
  if (!product) {
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        <h1 className="text-2xl font-bold">{('products.noResults')}</h1>
  ...
  const productDesc = product.description.en;
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          {product.variantOptions && (
            <div className="space-y-4">
              {product.variantOptions.sizes && product.variantOptions.sizes.length > 0 && (
                <div>
                  <Label className="mb-2">{('products.size')}</Label>
              ...
              {product.variantOptions.colors && product.variantOptions.colors.length > 0 && (
                <div>
                  <Label className="mb-2">{('products.color')}</Label>
          ...
          <div>
            {inStock ? (
              <Badge variant="outline" className="text-green-600 border-green-600">
                ...
                {/* {('products.availableStock', { stock: selectedVariant.stock })} */}
          ...
          {inStock && (
            <div>
              <Label className="mb-2">{('products.quantity')}</Label>
              ...
              {selectedVariant && (
                <div className="space-y-2">
                  ...
                  {selectedVariant.size && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">{('products.size')}:</span>
                  ...
                  {selectedVariant.color && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">{('products.color')}:</span>
                  ...
                  {selectedVariant.material && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">{('products.material')}:</span>
