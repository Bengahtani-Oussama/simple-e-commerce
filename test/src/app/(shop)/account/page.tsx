...
export default function AccountPage() {
  ...
  const menuItems = [
    {
      ...
      description: ('account.editProfile'),
      icon: User,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">{('account.title')}</h1>
        {/* <h1 className="text-3xl font-bold mb-2">{t('account.title')}</h1> */}
        <p className="text-muted-foreground">
          {('auth.welcome')}, {user.firstName}!
      ...
      <div className="grid gap-6 md:grid-cols-3 mt-8">
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-sm text-muted-foreground">{('addresses.title')}</p>
